  ...
  function addUser() {
    ...
    $.ajax({
      method: "POST",
      dataType: "json",
      url: "<?= $this->url->get('user/addUser') ?>", //tujuan data  func:addUser
  ...
  function editUser() {
    $.ajax({
      method: "POST",
      dataType: "json",
      url: "<?= $this->url->get('user/editUser') ?>", //tujuan data  func:addUser
      data: $('form.addUser').serialize(), //seri.. ubah jd format serialize
      success: function(res)/*result hasil bisa apa saja*/{
        new PNotify({
          title: res.title,
  ...
  function deleteUser() {
    $.ajax({
      method: "POST",
      dataType: "json",
      url: "<?= $this->url->get('user/deleteUser') ?>", //tujuan data  func:addUser
